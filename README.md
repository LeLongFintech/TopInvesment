...
Dự án tuân theo tiêu chuẩn **Client-Server Architecture**, chia làm 3 phân hệ độc lập nhằm tối ưu hóa hiệu suất xử lý dữ liệu lớn (Big Data). Dưới đây là sơ đồ tổng quan về cấu trúc luồng của toàn bộ hệ thống:
...
|                                                                                   |
|    +----------------+    +----------------+    +----------------+                 |
|    | Dashboard      |    | Lọc Cổ Tức     |    | Lọc Giá Trị    |   ...           |
|    | Analytics      |    | (Nút Sữa)      |    | (Nút Khiên)    |                 |
|    +----------------+    +----------------+    +----------------+                 |
|                                                                                   |
+-----------------------------------------------------------------------------------+
                                         | 
...
|    +-------------------------------------------------------------------------+    |
|    |                             Controllers (Routes)                        |    |
|    |      /api/v1/value   |  /api/v1/canslim   |   /api/v1/dividend          |    |
|    +-------------------------------------------------------------------------+    |
|                                        |                                          |
|    +-------------------------------------------------------------------------+    |
|    |                      Business Logic (Services Engine)                   |    |
|    |   +----------------+   +----------------+   +------------------+        |    |
|    |   | Graham Engine  |   | CANSLIM Engine |   | Dividend Engine  |        |    |
|    |   +----------------+   +----------------+   +------------------+        |    |
|    |   +----------------------------------------------------------+          |    |  
|    |   |        Data Aggregation & Chart Processing (Radar, v.v)  |          |    |
|    |   +----------------------------------------------------------+          |    |
|    +-------------------------------------------------------------------------+    |
|                                        |                                          |
|    +-------------------------------------------------------------------------+    |
|    |                    Data Access (Repositories & PyDantic)                |    |
|    |   +------------------------------------------------------------------+  |    |
|    |   |                            Raw SQL Engine                        |  |    |
|    |   +------------------------------------------------------------------+  |    |
|    +-------------------------------------------------------------------------+    |
...
+-----------------------------------------------------------------------------------+
|                                                                                   |
|                            DATA LAYER & PIPELINE (PostgreSQL)                     |
|                                                                                   |
|    +-------------------------------------------------------------------------+    |
|    |                           Data Warehouse (Tables)                       |    |
|    |                                                                         |    |
|    |   [stocks]  [market_data]  [income_statement]  [balance_sheet] ...      |    |
|    |                                                                         |    |
|    |   [graham_metrics]       |  [canslim_metrics] |  [dividend_metrics]     |    |
|    |   (Pre-computed Table)   |                    |                         |    |
|    +-------------------------------------------------------------------------+    |
|                                        ^                                          |
|    +-----------------------------------|-------------------------------------+    |
...
|    |                                                                         |    |
|    |  +--------------+    +------------------+    +-------------------+      |    |
|    |  | load_data.py | -> | compute_graham.py| -> | compute_canslim.py| ...  |    |
|    |  +--------------+    +------------------+    +-------------------+      |    |
|    +-------------------------------------------------------------------------+    |
|                                        ^                                          |
|    +-----------------------------------|-------------------------------------+    |
