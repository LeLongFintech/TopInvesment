      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-8">
        ...
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <button className="flex items-center gap-2 px-4 py-2 rounded-lg bg-card border border-line text-muted hover:text-heading hover:border-primary/50 transition-colors">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-card rounded-xl p-6 border border-line/30 flex flex-col gap-5 shadow-lg">
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex flex-col">
                ...
                <span className="text-xs text-muted">EPS growth &gt; 20% vs last year</span>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input defaultChecked className="sr-only peer" type="checkbox" />
                <div className="w-11 h-6 bg-el peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary"></div>
              </label>
            </div>
            <div className="w-full h-px bg-heading/5"></div>
            {/* Toggle 2 */}
            <div className="flex items-start justify-between gap-4">
              <div className="flex flex-col">
                <span className="text-sm font-semibold text-heading">Annual Earnings (A)</span>
                <span className="text-xs text-muted">3-Year EPS Growth &gt; 25%</span>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input defaultChecked className="sr-only peer" type="checkbox" />
                <div className="w-11 h-6 bg-el peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary"></div>
          ...
          <div className="bg-card rounded-xl p-6 border border-line/30 flex flex-col gap-5 shadow-lg">
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex flex-col">
                <span className="text-sm font-semibold text-heading">New Highs (N)</span>
                <span className="text-xs text-muted">Breaking out of base</span>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
            ...
            <div className="flex flex-col gap-3 mt-1">
              ...
              <div className="relative w-full h-2 bg-el rounded-lg">
          ...
          <div className="bg-card rounded-xl p-6 border border-line/30 flex flex-col gap-5 shadow-lg">
            <div className="flex items-center gap-3 mb-1">
              ...
              <h3 className="text-lg font-bold text-heading">Institutional Support</h3>
            </div>
            {/* Toggle 4 */}
            <div className="flex items-start justify-between gap-4">
              <div className="flex flex-col">
                <span className="text-sm font-semibold text-heading">Leader vs Laggard (L)</span>
                <span className="text-xs text-muted">Industry Group Rank Top 20%</span>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input defaultChecked className="sr-only peer" type="checkbox" />
                <div className="w-11 h-6 bg-el peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary"></div>
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex flex-col">
                <span className="text-sm font-semibold text-heading">Institutional Sponsorship (I)</span>
                <span className="text-xs text-muted">Increasing fund ownership</span>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input defaultChecked className="sr-only peer" type="checkbox" />
                <div className="w-11 h-6 bg-el peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary"></div>
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-bold text-heading flex items-center gap-2">
              Filtered Results
              <span className="text-sm font-normal text-muted bg-heading/5 px-2 py-1 rounded-full border border-heading/10">12 Matches</span>
            </h2>
            <div className="flex gap-2">
              <button className="p-2 hover:bg-heading/5 rounded-lg text-muted transition-colors">
          ...
          <div className="bg-card rounded-xl border border-line/30 overflow-hidden shadow-lg">
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="text-sm divide-y divide-line/20">
                  {/* Row 1 */}
                  <tr className="group hover:bg-heading/5 transition-colors">
                    <td className="p-4">
                    ...
                    <td className="p-4 text-heading">NVIDIA Corp</td>
                    <td className="p-4 text-right text-heading font-mono">$485.09</td>
                    ...
                    <td className="p-4 text-right text-muted">45.2M</td>
                    <td className="p-4 text-center">
                      <button className="text-primary hover:text-heading transition-colors">
                  ...
                  <tr className="group hover:bg-heading/5 transition-colors">
                    ...
                    <td className="p-4 text-heading">Microsoft Corporation</td>
                    <td className="p-4 text-right text-heading font-mono">$376.12</td>
                    ...
                    <td className="p-4 text-right text-muted">22.1M</td>
                    <td className="p-4 text-center">
                      <button className="text-primary hover:text-heading transition-colors">
                        <span className="material-symbols-outlined text-lg">add_circle</span>
                      </button>
                  ...
                  <tr className="group hover:bg-heading/5 transition-colors">
                    ...
                    <td className="p-4 text-heading">Amazon.com Inc</td>
                    <td className="p-4 text-right text-heading font-mono">$145.20</td>
                    ...
                    <td className="p-4 text-right text-muted">38.5M</td>
                    <td className="p-4 text-center">
                      <button className="text-primary hover:text-heading transition-colors">
                        <span className="material-symbols-outlined text-lg">add_circle</span>
                      </button>
                  ...
                  <tr className="group hover:bg-heading/5 transition-colors">
                    ...
                    <td className="p-4 text-heading">Tesla Inc</td>
                    <td className="p-4 text-right text-heading font-mono">$240.55</td>
                    ...
                    <td className="p-4 text-right text-muted">89.4M</td>
                    <td className="p-4 text-center">
                      <button className="text-primary hover:text-heading transition-colors">
                        <span className="material-symbols-outlined text-lg">add_circle</span>
                      </button>
            ...
            <div className="p-4 border-t border-line/50 flex items-center justify-between bg-heading/5">
              <span className="text-xs text-muted">Showing 1-4 of 12 results</span>
              <div className="flex items-center gap-2">
                <button className="w-8 h-8 flex items-center justify-center rounded-lg border border-line/50 text-muted hover:text-heading hover:bg-heading/10 disabled:opacity-50" disabled>
                ...
                <button className="w-8 h-8 flex items-center justify-center rounded-lg border border-line/50 text-muted hover:text-heading hover:bg-heading/10 text-xs">2</button>
                <button className="w-8 h-8 flex items-center justify-center rounded-lg border border-line/50 text-muted hover:text-heading hover:bg-heading/10 text-xs">3</button>
                <button className="w-8 h-8 flex items-center justify-center rounded-lg border border-line/50 text-muted hover:text-heading hover:bg-heading/10">
